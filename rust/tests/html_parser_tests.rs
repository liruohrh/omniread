...
const NOVEL_INFO_HTML: &str = include_str!("fixtures/js_api/novel_info.html");
const CHAPTER_CONTENT_HTML: &str = include_str!("fixtures/js_api/chapter_content.html");

const NOVEL_INFO_SCRIPT: &str = include_str!("fixtures/js_api/parse_novel_info.js");
const CHAPTERS_SCRIPT: &str = include_str!("fixtures/js_api/parse_chapters.js");
const CHAPTER_CONTENT_SCRIPT: &str = include_str!("fixtures/js_api/parse_chapter_content.js");

#[test]
fn test_parse_novel_info() {
    let mut rt = JsRuntime::new();
    let result = rt
        .execute(NOVEL_INFO_HTML, NOVEL_INFO_SCRIPT, None)
        .unwrap();
...
fn test_parse_chapter_content() {
    let mut rt = JsRuntime::new();
    let result = rt
        .execute(CHAPTER_CONTENT_HTML, CHAPTER_CONTENT_SCRIPT, None)
        .unwrap();
